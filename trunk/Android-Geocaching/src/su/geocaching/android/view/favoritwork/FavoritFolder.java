...
public class FavoritFolder extends Activity implements OnClickListener, OnItemClickListener {
	...
	ivSearch = (ImageView) findViewById(R.id.favorit_list_search_cache);
	ivDelete = (ImageView) findViewById(R.id.favorit_list_delete_cache);
